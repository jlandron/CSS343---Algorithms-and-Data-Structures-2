...
int main() {
	Poly A(5, 7), B(3, 4), C(2), D(A), X, Y, Z;
	Poly A2, B2, Z1, Z2;
	...
	// outputs exactly what is in quotes: "A = +5x^7 -4x^3 +10x -2"  5 7 -4 3 10 2 -1 -1
	cout << "A =" << A << endl;
	// outputs exactly what is in quotes: "B = +3x^4 +1x^3"          3 4 1 3 -1 -1
	cout << "B =" << B << endl << endl;
	...
	Y = A;
	Z = B;
	cout << "Test binary mixed operators" << endl;
	cout << "Y = "<< Y << endl;
	cout << "X = "<< X << endl;
	cout << "Z = "<< Z << endl;
	Y += X;
	...
	cout << "Test compund binary operators" << endl;
	Y += A -= B *= A;
	cout << "X =" << X << endl;
	cout << "Y =" << Y << endl << endl;
